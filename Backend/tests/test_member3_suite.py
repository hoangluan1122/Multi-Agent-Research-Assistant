...
async def run_member3_test_suite():
    ...
    async with AsyncClient(transport=transport, base_url="http://test") as client:
        ...
        assert sys_data["default_model"] == "gemini-2.0-flash"
        print("  [REQ-012 Web OK] Chuyển đổi về API mặc định của Web thành công (use_system_key = True, model = gemini-2.0-flash).")
